...
public class League {
    ...
    public void showBestTeam(Team[] theTeam) {
        ...
        for (Team team : theTeam) {
            System.out.println(team.getTeamName() + ": " + team.getPointsTotal() + ": " + team.getGoalsTotal());
            // currBestTeam = (team.getPointsTotal() > currBestTeam.getPointsTotal() ? team
            // : currBestTeam);
            if (team.getPointsTotal() > currBestTeam.getPointsTotal()) {
                currBestTeam = team;
            } else if (team.getPointsTotal() == currBestTeam.getPointsTotal()) {
                if (team.getGoalsTotal() > currBestTeam.getGoalsTotal()) {
                    currBestTeam = team;
                }
            }
        }
